...
import HeaderSignOut from "../header/header-sign-out";
...
const AuctionContainer = () => {
    ...
    useEffect(() => {
        const upComingProductsList = async () => {
            try {
                const expectedProductsList = await getLiveProductsGet_req();

...
import lastproducts from '../../redux/LastAuctionReducer';
                            ...
                            <div className="">
                                ...
                                <div className="mt-3">
                                    ...
                                    <div className="d-flex flex-column">
                                        ...
                                        <p className="font-14 mt-3 text-jumbatron Sans_Regular">
                                            Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                                            Placeat laborum distinctio nesciunt eius dolor nemo culpa dolorum,
                                            unde quisquam enim officiis cupiditate voluptatum aliquam eveniet iusto.
                                            Ratione reiciendis ullam consequatur.
                                            </p>
                                    </div>
                                </div>
                                <Divider />
                                <div className="">
                                    ...
                                    <div className="d-flex justify-content-end mt-5">
                                        ...
                                        />
                                        <button className={`btn Sans_Bold addFav  mr-5`}>Add to favorites</button>
                                        <button className={`btn Sans_Bold addBid  `}>Bid now</button>
                                    </div>
                                </div>
                            </div>
                        </div>
